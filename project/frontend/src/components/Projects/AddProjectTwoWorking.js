      ...
      <Card style={cardStyle}>
        <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
          <Tabs
            ...
            indicatorColor="primary" // Change the indicator color to blue
                  ...
                  <td align="left" style={generalInfoFieldsStyle}>
                    ...
                    <Select
                      ...
                      getOptionLabel={(option) =>
                        option.cityname + ', ' + option.state.replace('_', ' ')
                      }
          ...
          >
            <TableHead>
              ...
              <tr>
                ...
                <td style={generalInfoFieldsStyle}>Budgetary Submitted Date</td>
                <td align="left" style={generalInfoNameStyle}>
                  <div className={classes2.datePickerStyles}>
                    <DatePicker
                      dateFormat="MM/dd/yyyy"
              ...
              <tr>
                ...
                <td style={generalInfoFieldsStyle}>Proposal Submitted Date</td>
                <td align="left" style={generalInfoNameStyle}>
                  <div className={classes2.datePickerStyles}>
                    <DatePicker
                      dateFormat="MM/dd/yyyy"
